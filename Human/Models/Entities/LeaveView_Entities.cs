...
{
    public class LeaveView_Entities
    {
        ...
        public int DIR_EMP_ID { get; set; }
        public int SUP_EMP_ID { get; set; }
        public int MAN_EMP_ID { get; set; }
        public string FULLNAME_MAN { get; set; }
        public string FULLNAME_SUP { get; set; }
        public string FULLNAME_DIR { get; set; }
    }
}